...
/**
 * Laravel IFRS Accounting Configuration
 * 
 * Configured for Australian Professional Services Company
...
return [
    ...
    */
    ...
    /*
     ...
     |--------------------------------------------------------------------------
     |
     | These are the locales whose currencies can be localized for reporting.
     | Australian English (en_AU) is added for AUD reporting.
     |
     */
    'locales' => [
        'en_AU',
