...
class FrankingService
{
    ...
    /**
     * Create a manual franking entry (TC/DR/RF/FT/AJ — FD entries are
     ...
     * never disagree with the reporting calendar.
     */
    public static function recordEntry(array $attributes): FrankingAccountEntry
    {
        ...
        return FrankingAccountEntry::create([
            'entity_id' => $entity->id,
            'financial_year' => self::financialYearFor($attributes['entry_date'], $entity),
            ...
            'debit_amount' => $debit,
            'is_estimated' => (bool) ($attributes['is_estimated'] ?? false),
            'created_by' => auth()->id(),
        ]);
    }
