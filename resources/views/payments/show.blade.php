        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (select && amount) {
                const prefill = () => {
                    ...
                    if (due > 0) {
                        amount.value = Math.min(due, {{ $payment->unallocated_amount }}).toFixed(2);
                    }
                };
