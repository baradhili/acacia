            ...
            <div id="itemsContainer">
                @php
                    $items = old('items', $bill->items->map(fn ($item) => [
                        ...
                        'is_prepaid' => $item->is_prepaid ? '1' : '',
                        'service_start' => optional($item->service_start)->format('Y-m-d'),
                        'service_end' => optional($item->service_end)->format('Y-m-d'),
                        'amortise_to_account_id' => $item->amortise_to_account_id,
                    ])->all());
                @endphp
